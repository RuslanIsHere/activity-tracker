      ...
      {!user ? (
        <section className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-2">
          ...
          <div className="relative">
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-primary/10 via-transparent to-primary/5 blur-2xl" />
        ...
        <section className="mx-auto w-full max-w-4xl py-10">
          ...
          <p className="mt-3 text-muted-foreground">
            Home for authenticated users will be expanded when dashboard and
            calendar features are ready.
          </p>
        </section>
      )}
    </main>
